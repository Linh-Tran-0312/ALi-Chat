                ...
                <Grid container direction="row" justify="center" alignItems="flex-start" style={{ width: '100%' }}>
                    <Grid item sm={12} md={6} lg={4} style={{ height: '230px' }}>
                        <form encType="multipart/form-data" onSubmit={handleSubmitAvatar} ref={formRef} method="post">
                            <div className={classes.img_container} >
                                <ImageModal url={profile.avatar ? profile.avatar : '/default-avatar.jpg'} border="10px" minWidth="200px" minHeight="200px" maxWidth="200px" maxHeight="200px" />  
                    ...
                    <Grid item sm={12} md={6} lg={8} className={classes.details}   >
                        ...
                        <Box my={3} className={classes.flexStart}>
                            ...
                            {
                                matchXS &&  <Box my={2}><Button onClick={handleBackFromProfile} variant="contained" color="action" size="small" startIcon={<KeyboardBackspaceIcon />}>Back</Button>
                                </Box> 
                            }
                        </Box>
                    </Grid>
